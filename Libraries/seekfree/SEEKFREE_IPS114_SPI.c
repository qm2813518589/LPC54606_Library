...
{
    (void)spi_init(IPS114_SPIN_PIN, IPS114_CS_PIN, IPS114_SCL_PIN, IPS114_SDA_PIN, IPS114_SDA_IN_PIN, 0, 50*1000*1000);//硬件SPI初始化
    
    gpio_init(IPS114_BL_PIN,GPO,1,NOPULL);
    gpio_init(IPS114_DC_PIN,GPO,0,NOPULL);
    gpio_init(IPS114_REST_PIN,GPO,0,NOPULL);

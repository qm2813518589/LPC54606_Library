 ...
 * @note		
					...
					------------------------------------ 
						模块管脚            单片机管脚
						SCL                 查看IPS114_SCL宏定义的引脚     硬件SPI引脚不可随意切换
						SDA                 查看IPS114_SDA宏定义的引脚     硬件SPI引脚不可随意切换
						RES                 查看IPS114_REST_PIN宏定义的引脚    
						DC                  查看IPS114_DC_PIN宏定义的引脚  
						CS                  查看IPS114_CS宏定义的引脚      硬件SPI引脚不可随意切换
...
//-----------------引脚定义------------------------------
#define IPS114_SPIN_PIN       	SPI_4           //定义使用的SPI号
#define IPS114_SCL_PIN        	SPI4_SCK_B19    //定义SPI_SCK引脚
#define IPS114_SDA_PIN        	SPI4_MOSI_B21   //定义SPI_MOSI引脚
#define IPS114_SDA_IN_PIN     	SPI4_MISO_B20   //定义SPI_MISO引脚  TFT没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
#define IPS114_CS_PIN         	SPI4_CS0_B9     //定义SPI_CS引脚
         
#define IPS114_BL_PIN      		B20	            //液晶背光引脚定义
#define IPS114_REST_PIN    		B8              //液晶复位引脚定义
#define IPS114_DC_PIN 	    	B10	            //液晶命令位引脚定义

...
//-------------------------------------------------------------------------------------------------------------------
#define SPI_NUM         SPI_6           
#define SPI_SCK_PIN     SPI6_SCK_B12    //接模块SPC
#define SPI_MOSI_PIN    SPI6_MOSI_B13   //接模块SDI
#define SPI_MISO_PIN    SPI6_MISO_B16   //接模块SDO
#define SPI_CS_PIN      SPI6_CS0_A15     //接模块CS

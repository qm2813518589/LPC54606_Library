...
{
	IPS200_DATAPORT = (dat << DATA_START_NUM);
}
...
void ips200_init(void)
{
	...
	gpio_init(IPS200_D0_PIN, GPO, 0, NOPULL); 
	gpio_init(IPS200_D1_PIN, GPO, 0, NOPULL);
	gpio_init(IPS200_D2_PIN, GPO, 0, NOPULL);
	gpio_init(IPS200_D3_PIN, GPO, 0, NOPULL);
	gpio_init(IPS200_D4_PIN, GPO, 0, NOPULL);
	gpio_init(IPS200_D5_PIN, GPO, 0, NOPULL);
	gpio_init(IPS200_D6_PIN, GPO, 0, NOPULL);
	gpio_init(IPS200_D7_PIN, GPO, 0, NOPULL); 
                                     
	gpio_init(IPS200_BL_PIN, GPO, 0, NOPULL);
	gpio_init(IPS200_CS_PIN, GPO, 0, NOPULL);
	gpio_init(IPS200_RST_PIN,GPO, 0, NOPULL);
	gpio_init(IPS200_RS_PIN, GPO, 0, NOPULL);
	gpio_init(IPS200_WR_PIN, GPO, 0, NOPULL);
	gpio_init(IPS200_RD_PIN, GPO, 0, NOPULL);
    
    GPIO->MASK[IPS200_D0_PIN >> 5] = ~((uint32)(0xff) << DATA_START_NUM);
...
void ips200_showint32(uint16 x,uint16 y,int dat,uint8 num)
{
    ...
    ips200_showstr(x, y, (uint8 *)buff);	//显示数字
}

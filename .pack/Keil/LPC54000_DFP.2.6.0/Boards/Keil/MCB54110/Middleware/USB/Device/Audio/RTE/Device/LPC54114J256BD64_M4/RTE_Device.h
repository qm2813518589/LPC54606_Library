...
#define   RTE_FC4_CTS_SDA_SSEL0_ID          1
...
#define   RTE_FC4_RTS_SCL_SSEL1_ID          1
...
#define   RTE_FC6_PERSEL                    3

//     <h>Pin Configuration
//       <o>FC6_SCK Pin <0=> Not used <1=> PIO0_7
#define   RTE_FC6_SCK_ID                    1
#if      (RTE_FC6_SCK_ID == 0)
...
#define   RTE_FC6_RXD_SDA_MOSI_ID           1
...
#define   RTE_FC6_TXD_SCL_MISO_ID           1
...
#define   RTE_FC7_PERSEL                    3

//     <h>Pin Configuration
//       <o>FC7_SCK Pin <0=> Not used <1=> PIO1_6 <2=> PIO1_12
#define   RTE_FC7_SCK_ID                    2
#if      (RTE_FC7_SCK_ID == 0)
...
#define   RTE_FC7_RXD_SDA_MOSI_ID           2
...
#define   RTE_FC7_TXD_SCL_MISO_ID           2
